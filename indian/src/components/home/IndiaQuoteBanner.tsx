...
export default function IndiaQuoteBanner() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full bg-white py-20 lg:py-32 px-6 md:px-12 text-[#171717] overflow-hidden border-y border-neutral-100 select-none"
    >
      {/* Background Soft Blush & Dot-Grid Texture (Layer 0) */}
      ...
      {/* Large Ghost Quotation Mark with Continuous Ambient Drift */}
      <motion.div
        animate={
          shouldReduceMotion
            ? false
      ...
      <div className="max-w-6xl mx-auto relative z-10 text-center flex flex-col items-center">
        ...
        <motion.div style={{ scale, opacity }} className="space-y-8 flex flex-col items-center">
          ...
          <blockquote className="font-serif text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.25] text-[#171717] max-w-5xl">
            "INDIA'S ONLY SCHOOL TO LEARN AI SKILLS FROM TECH STARTUP FOUNDERS & LEADERS."
          </blockquote>

          {/* Subline with Center-Outward Drawing Flanks */}
