  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="py-16 px-6 md:px-12 max-w-4xl mx-auto space-y-6 text-sm text-slate-600 leading-relaxed font-medium">
        <p>
          At The AI School USA, accessible from our platforms, one of our main priorities is the privacy of our visitors and students. This Privacy Policy document contains types of information that is collected and recorded by The AI School and how we use it.
        </p>
